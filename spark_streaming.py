...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             .appName("RealTimeVotingSystem")
             .config('spark.jars.packages', 'org.apache.spark:spark-sql-kafka-0-10_2.13:3.5.1')
             .config("spark.jars",
                     "/home/achraf-eccharef/DE/projects/project1/RealtimeVoting/postgresql-42.7.3.jar")  # PostgreSQL driver
    ...
    votes_per_candidate = enriched_votes_df.groupby("candidate_id", "candidate_name", "party_affiliation",
                                                    "photo_url").agg(_sum('votes').alias("total_votes"))
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation",
                "/home/achraf-eccharef/DE/projects/project1/RealtimeVoting/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation",
                "/home/achraf-eccharef/DE/projects/project1/RealtimeVoting/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
